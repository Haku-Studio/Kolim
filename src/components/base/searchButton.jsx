export default function SearchButton(){
    return (
        <div className="px-4 py-3">
            <button className="py-[10px] px-[12px] border border-solid border-greyScale100 bg-greyScale0 flex items-center space-x-2 rounded-full w-full ">
                ...
                <span className="w-full text-left text-sm">Rechercher un depart</span>
            </button>
        </div>
