    ...
    <form className="space-y-3" autoComplete="off">
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-[6px]">
          ...
          />
          {formErrors.from && (
            <span className="text-red-500 text-xs">{formErrors.from}</span>
          )}
        </div>
        <div className="space-y-[6px]">
          ...
          />
          {formErrors.to && (
            <span className="text-red-500 text-xs">{formErrors.to}</span>
          )}
        </div>
      </div>
      <div className="space-y-[6px]">
        ...
        <input
          onChange={(e) =>
            setFormData({
              ...formData,
              weightAvailable: Number(e.target.value),
            })
          }
      ...
      <div className="space-y-[6px]">
        ...
        {formErrors.pricePerKg && (
          <span className="text-red-500 text-xs">{formErrors.pricePerKg}</span>
        )}
      </div>
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-[6px]">
      ...
      <div className="space-y-[6px]">
        ...
        {formErrors.phoneNumber && (
          <span className="text-red-500 text-xs">{formErrors.phoneNumber}</span>
        )}
      </div>
    </form>
  );
